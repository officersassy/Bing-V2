...
const CRATE_CATALOG = [
  ...
  ,{"id":"ball-red","name":"Ruby Red Ball","rarity":"common"}
  ,{"id":"ball-green","name":"Emerald Ball","rarity":"common"}
  ,{"id":"ball-purple","name":"Royal Purple Ball","rarity":"rare"}
  ,{"id":"ball-pink","name":"Hot Pink Ball","rarity":"rare"}
  ,{"id":"ball-orange","name":"Sassy Orange Ball","rarity":"rare"}
  ,{"id":"ball-gold","name":"Midas Ball","rarity":"epic"}
  ,{"id":"ball-cyan","name":"Neon Cyan Ball","rarity":"legendary"}
];

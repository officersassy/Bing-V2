export const SHOP_ITEMS = [
  { id:"avatar-ball", name:"Classic Bingo Ball", price:0, icon:"🎱", type:"avatar", tier:"free" },
  { id:"avatar-smile", name:"Happy Dobber", price:0, icon:"😄", type:"avatar", tier:"free" },
  { id:"avatar-star", name:"Lucky Star", price:0, icon:"⭐", type:"avatar", tier:"free" },
  { id:"avatar-clover", name:"Lucky Clover", price:0, icon:"🍀", type:"avatar", tier:"free" },
  { id:"avatar-crown", name:"Little Crown", price:0, icon:"👑", type:"avatar", tier:"free" },

  { id:"avatar-gold-crown", name:"Golden Crown", price:300, icon:"👑", type:"avatar", tier:"premium" },
  { id:"avatar-disco", name:"Disco Ball", price:450, icon:"🪩", type:"avatar", tier:"premium" },
  { id:"avatar-fire", name:"Flaming Bingo", price:600, icon:"🔥", type:"avatar", tier:"premium" },
  { id:"avatar-diamond", name:"Diamond", price:900, icon:"💎", type:"avatar", tier:"premium" },
  { id:"avatar-skull", name:"Neon Skull", price:1250, icon:"💀", type:"avatar", tier:"premium" },
  { id:"avatar-jackpot", name:"Jackpot", price:1750, icon:"🎰", type:"avatar", tier:"premium" },
  { id:"avatar-sassy", name:"General Sassy Approved", price:3000, icon:"🫡", type:"avatar", tier:"legendary" },

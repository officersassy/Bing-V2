export const SHOP_ITEMS = [
  { id:"avatar-ball", name:"Classic Bingo Ball", price:0, icon:"🎱", image:"assets/avatars/avatar-ball.png", type:"avatar", tier:"free" },
  { id:"avatar-smile", name:"Happy Dobber", price:0, icon:"😄", image:"assets/avatars/avatar-smile.png", type:"avatar", tier:"free" },
  { id:"avatar-star", name:"Lucky Star", price:0, icon:"⭐", image:"assets/avatars/avatar-star.png", type:"avatar", tier:"free" },
  { id:"avatar-clover", name:"Lucky Clover", price:0, icon:"🍀", image:"assets/avatars/avatar-clover.png", type:"avatar", tier:"free" },
  { id:"avatar-crown", name:"Little Crown", price:0, icon:"👑", image:"assets/avatars/avatar-crown.png", type:"avatar", tier:"free" },

  { id:"avatar-gold-crown", name:"Golden Crown", price:300, icon:"👑", image:"assets/avatars/avatar-gold-crown.png", type:"avatar", tier:"premium" },
  { id:"avatar-disco", name:"Disco Ball", price:450, icon:"🪩", image:"assets/avatars/avatar-disco.png", type:"avatar", tier:"premium" },
  { id:"avatar-fire", name:"Flaming Bingo", price:600, icon:"🔥", image:"assets/avatars/avatar-fire.png", type:"avatar", tier:"premium" },
  { id:"avatar-diamond", name:"Diamond", price:900, icon:"💎", image:"assets/avatars/avatar-diamond.png", type:"avatar", tier:"premium" },
  { id:"avatar-skull", name:"Neon Skull", price:1250, icon:"💀", image:"assets/avatars/avatar-skull.png", type:"avatar", tier:"premium" },
  { id:"avatar-jackpot", name:"Jackpot", price:1750, icon:"🎰", image:"assets/avatars/avatar-jackpot.png", type:"avatar", tier:"premium" },
  { id:"avatar-sassy", name:"General Sassy Approved", price:3000, icon:"🫡", image:"assets/avatars/avatar-sassy.png", type:"avatar", tier:"legendary" },
